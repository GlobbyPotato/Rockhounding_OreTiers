...
public class PeatDrier extends MachineIO {

	public PeatDrier(String name) {
		super(Reference.MODID, name, Material.WOOD, TileEntityPeatDrier.class, GuiHandler.peatDrierID, 0.2F);
